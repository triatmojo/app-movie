...
@section('title', 'Our selected movies for your mood')
     ...
     <div class="flex gap-14 items-start">
        ...
        <div class="flex flex-col gap-10">
            ...
            <div class="w-full relative overflow-hidden group">
                ...
                <a href="{{ $movie->trailer }}" class="inset-0 absolute z-50">
                </a>
            </div>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-stream-gray text-base mt-[6px]">
                        Action • {{ $movie->categories }} - Released at {{ date('Y', strtotime($movie->release_date))}}
                    </p>
                </div>
